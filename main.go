...
type keyCmd struct {
	Name    string `short:"n" long:"name" description:"Key name" default:"Developer"`
	Comment string `short:"c" long:"comment" description:"Key comment" default:"Generated by asserts-tool"`
	Email   string `short:"e" long:"email" description:"Key email" default:"developer@local"`
}
